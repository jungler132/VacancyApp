...
export const SOURCES: SourceInfo[] = [
  ...
  { id: 'adzuna', name: 'Adzuna', regionLabel: 'EU / US / Asia', status: 'key', note: 'Нужны APP_ID и APP_KEY' },
  { id: 'jooble', name: 'Jooble', regionLabel: '70+ стран', status: 'key', note: 'Нужен JOOBLE_KEY' },
