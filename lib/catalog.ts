...
export const CATEGORIES: {
  ...
  { id: 'all', label: 'Все сферы', icon: '✦', ru: '', en: '' },
  { id: 'sales', label: 'Продажи', icon: '🛒', ru: 'продавец менеджер по продажам', en: 'sales retail shop assistant' },
  { id: 'medicine', label: 'Медицина', icon: '✚', ru: 'врач медсестра фармацевт', en: 'nurse doctor healthcare medical' },
  { id: 'logistics', label: 'Логистика', icon: '🚚', ru: 'водитель курьер склад логист', en: 'driver warehouse logistics courier' },
  { id: 'construction', label: 'Стройка', icon: '🧱', ru: 'строитель сварщик разнорабочий', en: 'construction welder carpenter electrician' },
  { id: 'education', label: 'Образование', icon: '🎓', ru: 'учитель преподаватель воспитатель', en: 'teacher tutor education school' },
  { id: 'hospitality', label: 'Общепит', icon: '🍽', ru: 'повар официант бармен', en: 'cook chef waiter bartender hospitality' },
  { id: 'manufacturing', label: 'Производство', icon: '🏭', ru: 'оператор токарь слесарь завод', en: 'factory operator manufacturing production' },
  { id: 'finance', label: 'Финансы', icon: '💳', ru: 'бухгалтер экономист кассир', en: 'accountant finance cashier bank' },
  { id: 'admin', label: 'Офис', icon: '🗂', ru: 'секретарь администратор офис-менеджер', en: 'assistant administrator office receptionist' },
  { id: 'it', label: 'IT', icon: '💻', ru: 'программист разработчик', en: 'developer software engineer' },
  { id: 'marketing', label: 'Маркетинг', icon: '📣', ru: 'маркетолог smm дизайнер', en: 'marketing designer smm content' },
  { id: 'legal', label: 'Юриспруденция', icon: '⚖', ru: 'юрист адвокат', en: 'lawyer legal counsel attorney' },
  { id: 'agriculture', label: 'Агро', icon: '🌾', ru: 'агроном тракторист', en: 'farm agriculture agronomist' },
  { id: 'security', label: 'Охрана', icon: '🛡', ru: 'охранник безопасность', en: 'security guard' },
  { id: 'beauty', label: 'Красота', icon: '💅', ru: 'парикмахер косметолог мастер маникюра', en: 'beauty salon hairdresser nail' },
  { id: 'hr', label: 'HR', icon: '👥', ru: 'рекрутер кадровик hr', en: 'recruiter hr human resources' },
  { id: 'home', label: 'Дом и уход', icon: '🏠', ru: 'няня сиделка домработница уборщица', en: 'nanny caregiver cleaner housekeeper' },
];
